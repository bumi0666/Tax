...
const GUIDES = [
  ...
  {
    slug: "freelancer-tax-20m",
    title: "프리랜서 연소득 2,000만원 종합소득세·환급 계산",
    desc: "연 2,000만원 프리랜서 기준, 조건별 예상 세액을 CASE별로 비교했습니다.",
  },
  {
    slug: "freelancer-tax-30m",
    title: "프리랜서 연소득 3,000만원 종합소득세·환급 계산",
    desc: "연 3,000만원 프리랜서 기준, 경비율에 따라 결과가 어떻게 갈리는지 정리했습니다.",
  },
  {
    slug: "filing-steps",
